...
function add_month($data = array()) {
    ...
    public function delete($params = array()) {
        if (isset($params['payment_payment_id'])) {
            $this->db->where('payment_payment_id', $params['payment_payment_id']);
        }
        if (isset($params['student_student_id'])) {
            $this->db->where('student_student_id', $params['student_student_id']);
        }
        $this->db->delete('bulan');
    }
    

    public function delete_all_by_payment_id($payment_id) {
        if (isset($payment_id)) {
            $this->db->where('payment_payment_id', $payment_id);
        }
        $this->db->delete('bulan');
    }
