...
<div class="content-wrapper">
					...
					<div class="modal-body">
						<div id="p_scents_class">
							<p>
								...
								<input type="text" required="" name="class_name[]" class="form-control" placeholder="Contoh: Ulya II">
							</p>
						</div>
						<p>
    ...
    $(function() {
        ...
        $("#addScnt_class").click(function() {
            ...
            $('<p>\
                <label>Nama Kelas</label>\
                <input required type="text" name="class_name[]" class="form-control" placeholder="Contoh: Ulya II">\
                <label>Wali Kelas</label>\
                ' + waliKelasDropdown + '\
                <a href="#" class="btn btn-xs btn-danger remScnt_class">Hapus Baris</a>\
            </p>').appendTo(scntDiv);
