				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input name="majors_name" type="text" class="form-control" value="<?php echo $inputMajorsValue ?>" placeholder="Isi Nama Kamar">
						</div>

						<div class="form-group">
							<label>Singkatan Kamar <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
							<input name="majors_short_name" type="text" class="form-control" value="<?php echo $inputShortValue ?>" placeholder="Isi Singkatan Kamar">
						</div>
