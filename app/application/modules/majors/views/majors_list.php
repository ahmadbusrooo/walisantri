					...
					<div class="box-header">
						...
						<div class="box-tools">
							...
							<div class="input-group input-group-sm" style="width: 250px;">
								<input type="text" id="field" autofocus name="n" <?php echo (isset($f['n'])) ? 'placeholder="' . $f['n'] . '"' : 'placeholder="Nama Kamar"' ?> class="form-control" required>
				...
				<div id="p_scents_majors">
					<div class="row">
						<div class="col-md-6">
							...
							<input type="text" required="" name="majors_name[]" class="form-control" placeholder="Contoh: E1 ">
						</div>
						<div class="col-md-6">
							<label>Nama Komplek</label>
							<select name="komplek_id[]" class="form-control" required>
								<option value="">-- Pilih Komplek --</option>
								<?php foreach ($komplek as $k) : ?>
									<option value="<?= $k['komplek_id']; ?>"><?= $k['komplek_name']; ?></option>
								<?php endforeach; ?>
							</select>
