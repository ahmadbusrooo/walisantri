...
class Setting_set extends CI_Controller {
    ...
    public function index() {
        ...
        $this->form_validation->set_rules('setting_school', 'Nama Pondok', 'trim|required|xss_clean');
        ...
        $this->form_validation->set_rules('setting_city', 'Nama Kota/Kab', 'trim|required|xss_clean');
         ...
         $this->form_validation->set_rules('setting_wa_gateway_url', 'User SMS Gateway', 'trim|required|xss_clean');
         $this->form_validation->set_rules('setting_wa_api_key', 'Pass SMS Gateway', 'trim|required|xss_clean');
        ...
        if ($_POST AND $this->form_validation->run() == TRUE) {
            ...
            $param['setting_wa_gateway_url'] = $this->input->post('setting_wa_gateway_url');
            $param['setting_wa_api_key'] = $this->input->post('setting_wa_api_key');
            ...
            $data['setting_wa_gateway_url'] = $this->Setting_model->get(array('id' => 8));
            $data['setting_wa_api_key'] = $this->Setting_model->get(array('id' => 9));
