...
class Setting_model extends CI_Model {
    ...
    public function save($param = array()) {
        ...
        if (isset($param['setting_wa_gateway_url'])) {
            $this->db->set('setting_value', $param['setting_wa_gateway_url']);
            $this->db->where('setting_id', 8);
            $this->db->update('setting');
        }

        if (isset($param['setting_wa_api_key'])) {
            $this->db->set('setting_value', $param['setting_wa_api_key']);
