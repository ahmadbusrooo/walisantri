<section class="content">
  <div class="row"> 
    <div class="col-md-12">
      <div class="box box-info box-solid" style="border: 1px solid #206d25 !important;">
        ...
        <div class="box-body">
          ...
          <div class="form-group">            
            ...
            <label for="" class="col-sm-2 control-label">Cari Data Santri</label>
            <div class="col-sm-2">
              <input type="text" autofocus name="r" <?php echo (isset($f['r'])) ? 'placeholder="'.$f['r'].'"' : 'placeholder="Masukan NIS Santri"' ?> class="form-control" required>
            </div>
