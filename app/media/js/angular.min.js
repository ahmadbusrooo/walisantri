...
(function (M, Y, t) {
    ...
    function sc(b, a, c) {
        ...
        M &&
            e.test(M.name) &&
            ((c.debugInfoEnabled = !0), (M.name = M.name.replace(e, "")));
    ...
    function xb(b, a) {
        ...
        d &&
            (a ?
                delete d.data[a] :
                (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Hc(b)),
                    delete zb[c],
                    (b.ng339 = t)));
    }
    ...
    function mf(b) {
        return (b = b.toString().replace(Oc, "").match(Pc)) ?
    ...
    function Vb(b, a, c) {
        ...
        if ("function" === typeof b) {
            ...
            D(b) ?
            ((a = b.length - 1), sb(b[a], "fn"), (d = b.slice(0, a))) :
            sb(b, "fn", !0);
        return d;
    }
    ...
    function pf(b, a, c, d) {
                ...
                !d.history || (g && f) ?
                    (g || (X = a),
                        ...
                        ((c = q),
                            ...
                            (c.hash = a)) :
                        (q.href = a)) :
                    (u[c ? "replaceState" : "pushState"](e, "", a), h(), (P = x));
                return m;
            }
        ...
        m.cookies = function (a, b) {
            ...
            if (a)
                ...
                if (n.cookie !== y)
                    for (
                        y = n.cookie, d = y.split("; "), ea = {}, f = 0; f < d.length; f++
                    )
                        (e = d[f]),
                        (g = e.indexOf("=")),
                        0 < g &&
                        ((a = k(e.substring(0, g))),
                            ea[a] === t && (ea[a] = k(e.substring(g + 1))));
                return ea;
            }
        };
            ...
            function (a, b, c, r, O, p, v, w, L, C, x) {
                ...
                function S(a, b, c, d, e, f) {
                    function g(a, c, d, e) {
                        ...
                        for (n = h.length; q < n;)
                            ...
                            c ?
                            (c.scope ?
                                ((k = a.$new()), E.$$addScopeInfo(B(l), k)) :
                                (k = a),
                                (p = c.transcludeOnThisElement ?
                                    X(a, c.transclude, e, c.elementTranscludeOnThisElement) :
                                    ...
                                    null),
                                c(f, k, l, d, p)) :
                            f && f(a, l.childNodes, t, e);
                    }
                    for (var h = [], l, k, q, n, r, p = 0; p < a.length; p++) {
                        l = new Xb();
                        k = W(a[p], [], l, 0 === p ? d : t, e);
                        (f = k.length ? ea(k, a[p], l, b, c, null, [], [], f) : null) &&
                        f.scope &&
                            E.$$addScopeClass(l.$$element);
                        l =
                            (f && f.terminal) || !(q = a[p].childNodes) || !q.length ?
                            null :
                            S(
                                q,
                                f ?
                ...
                function W(a, b, c, d, g) {
                    ...
                    switch (a.nodeType) {
                        case oa:
                            ca(b, ya(ua(a)), "E", d, g);
                            for (
                                var k, q, n, r = a.attributes, p = 0, w = r && r.length; p < w; p++
                            ) {
                                var O = !1,
                                    L = !1;
                                k = r[p];
                ...
                function ea(a, d, e, f, g, l, k, n, r) {
                    ...
                    function v(a, c, f, g, h) {
                        ...
                        if (S) {
                            E.$$addScopeInfo(
                                ...
                                x,
                                !0,
                                !(ka && (ka === S || ka === S.$$originalDirective))
                            );
                            E.$$addScopeClass(W, !0);
                            g = X && X[S.name];
                            var xa = x;
                            ...
                            s((x.$$isolateBindings = S.$$isolateBindings), function (a, d) {
                                ...
                                switch (a.mode) {
                                    ...
                                    case "=":
                                        ...
                                        f.$stateful = !0;
                                        f = a.collection ?
                                            c.$watchCollection(J[e], f) :
                                            c.$watch(O(J[e], f), null, h.literal);
                                        x.$on("$destroy", f);
                                        break;
                                    case "&":
                                        (h = O(J[e])),
                        ...
                        for (r = k.length; g < r; g++)
                            ...
                            $(
                                ...
                                W,
                                J,
                                w.require && L(w.directiveName, w.require, W, P),
                                eb
                            );
                        var wa = c;
                    ...
                    for (
                        ...
                        if ((N = K.scope))
                            K.templateUrl ||
                            (I(N) ?
                                (Oa("new/isolated scope", S || P, K, aa), (S = K)) :
                                Oa("new/isolated scope", S, K, aa)),
                            (P = P || K);
                        z = K.name;
                        !K.templateUrl &&
                            K.controller &&
                        ...
                        if (K.template)
                            if (
                                ((A = !0),
                                    Oa("template", ka, K, aa),
                                    (ka = K),
                                    (N = G(K.template) ? K.template(aa, e) : K.template),
                                    (N = Sc(N)),
                                    K.replace)
                            ) {
                                l = K;
                    ...
                    if (d.hasOwnProperty(e)) {
                        ...
                        for (var r = 0, p = e.length; r < p; r++)
                            try {
                                if (
                                    ((q = e[r]),
                                        (g === t || g > q.priority) && -1 != q.restrict.indexOf(f))
                                ) {
                                    if (l) {
                                        var w = {
                                            $$start: l,
                ...
                function A(b) {
                    if (d.hasOwnProperty(b))
                        for (
                            var c = a.get(b + "Directive"), e = 0, f = c.length; e < f; e++
                        )
                ...
                function T(a, b, c, d, e, f, g, h) {
                    ...
                    return function (a, b, c, d, e) {
                        ...
                        b.$$destroyed ||
                            (l ?
                                l.push(b, c, d, a) :
                                (k.transcludeOnThisElement && (a = X(b, k.transclude, e)),
                                    k(q, b, c, d, a)));
                    };
                }
                ...
                Xb.prototype = {
                    ...
                    $set: function (a, b, d, e) {
                        ...
                        e
                            ?
                            (this.$attr[a] = e) :
                            (e = this.$attr[a]) || (this.$attr[a] = e = tc(a, "-"));
                        g = ua(this.$$element);
                ...
                return function (g, h, l, k) {
                    ...
                    F(g) &&
                        ((k = g.match(c)),
                            (n = k[1]),
                            (q = q || k[3]),
                            (g = b.hasOwnProperty(n) ?
                                b[n] :
                                vc(h.$scope, n, !0) || (a ? vc(e, n, !0) : t)),
                            sb(g, n, !0));
                    if (l)
                        return (
                            (l = (D(g) ? g[g.length - 1] : g).prototype),
            ...
            function (d, e, f, g, h, l) {
                function k(a) {
                    function c(a) {
                        var b = z({}, a);
                        b.data = a.data ?
                            Yc(a.data, a.headers, a.status, e.transformResponse) :
                            a.data;
                        a = a.status;
                ...
                function m(c, f) {
                    function l(b, c, d, e) {
                        ...
                        P &&
                            (200 <= b && 300 > b ? P.put(X, [b, c, Wc(d), e]) : P.remove(X));
                    ...
                    !1 === c.cache ||
                        ...
                        (P = I(c.cache) ? c.cache : I(b.cache) ? b.cache : q);
                    P &&
                        ((E = P.get(X)),
                            y(E) ?
                            E && G(E.then) ?
                            E.then(w, w) :
                            D(E) ?
                            m(E[1], E[0], ra(E[2]), E[3]) :
                            m(E, 200, {}, "OK") :
                            P.put(X, x));
                    A(E) &&
                        ((E = Zc(c.url) ?
                                e.cookies()[c.xsrfCookieName || b.xsrfCookieName] :
                                t) && (s[c.xsrfHeaderName || b.xsrfHeaderName] = E),
                            d(
                                c.method,
                                X,
                                f,
    ...
    function wf(b, a, c, d, e) {
        ...
        return function (e, h, l, k, m, n, q, u) {
            ...
            if ("jsonp" == Q(e)) {
                ...
                var v = f(
                    h.replace("JSON_CALLBACK", "angular.callbacks." + p),
                    p,
                    function (a, b) {
                        O(k, a, d[p].data, "", b);
                        d[p] = H;
        ...
        this.$get = [
            ...
            function (c, d, e) {
                ...
                function g(f, g, u, r) {
                    ...
                    r = !!r;
                    for (
                        var v, w, L = 0, C = [], x = [], P = f.length, E = [], s = []; L < P;

                    )
                        if (-1 != (v = f.indexOf(b, L)) && -1 != (w = f.indexOf(a, v + h)))
                            L !== v && E.push(O(f.substring(L, v))),
                            (L = f.substring(v + h, w)),
                            C.push(L),
                            x.push(c(L, p)),
                            (L = w + l),
            ...
            function (b, a, c, d) {
                function e(e, h, l, k) {
                    ...
                    O.$$intervalId = m(function () {
                        ...
                        0 < l &&
                            q >= l &&
                            (r.resolve(q), n(O.$$intervalId), delete f[O.$$intervalId]);
                        u || b.$apply();
                    }, h);
                    f[O.$$intervalId] = r;
                    return O;
                        ...
                        case "string":
                            ...
                            v ||
                                (":" === d.charAt(0) &&
                                    ...
                                    (g = g ? u : q),
                                    (v = new gc(g)),
                                    (v = new hb(v, c, g).parse(d)),
                                    v.constant ?
                                    (v.$$watchDelegate = m) :
                                    w ?
                                    ((v = e(v)), (v.$$watchDelegate = v.literal ? k : l)) :
            ...
            function (e, f, g, h) {
                ...
                l.prototype = {
                    ...
                    $broadcast: function (a, b) {
                        ...
                        for (var g = Ya([e], arguments, 1), h, l;
                            (c = d);) {
                            e.currentScope = c;
                            d = c.$$listeners[a] || [];
                            h = 0;
    ...
    function Ue() {
        this.$get = [
            ...
            function (b, a) {
                var c = {},
                    d = ba(
                        (/android (\d+)/.exec(Q((b.navigator || {}).userAgent)) || [])[1]
                    ),
                ...
                if (l) {
                    ...
                    !d ||
                        (k && m) ||
                        ((k = F(f.body.style.webkitTransition)),
            ...
            function (b, a, c) {
                return {
                    ...
                    findModels: function (a, b, c) {
                        for (
                            var g = ["ng-", "data-ng-", "ng\\:"], h = 0; h < g.length;
                            ++h
                        ) {
        ...
        return function (e, f, g, h, l, k, m) {
            ...
            h.$parsers.push(function (b) {
                return h.$isEmpty(b) ?
                    ...
                    a.test(b) ?
                    ((b = c(b, r)),
                        "UTC" === u && b.setMinutes(b.getMinutes() - b.getTimezoneOffset()),
                        b) :
                    t;
            });
    ...
    function td(b, a, c, d) {
        (d.$$hasNativeValidators = I(a[0].validity)) &&
    ...
    function sd(b) {
        ...
        d.$setValidity = function (b, e, f) {
            ...
            d.$pending ?
                (a(xd, !0), (d.$valid = d.$invalid = t), c("", null)) :
                (a(xd, !1),
                    (d.$valid = wd(d.$error)),
                    (d.$invalid = !d.$valid),
                    c("", d.$valid));
    ...
    var La = (R.prototype = {
            ready: function (b) {
                ...
                "complete" === Y.readyState ?
                    setTimeout(a) :
                    (this.on("DOMContentLoaded", a), R(M).on("load", a));
            },
            toString: function () {
                var b = [];
                s(this, function (a) {
    ...
    s({
            ...
            on: function a(c, d, e, f) {
                ...
                if (Ec(c)) {
                    ...
                    h || (h = g.handle = lf(c, f));
                    for (
                        var g = 0 <= d.indexOf(" ") ? d.split(" ") : [d], l = g.length; l--;
                        ...
                        return {
                            ...
                            setClass: function (a, c, d, e) {
                                ...
                                m
                                    ...
                                    e &&
                                    m.options &&
                                    (m.options = ga.extend(m.options || {}, e)) :
                                    ((m = {
                                        classes: {},
                                        options: e
                                    }), (l = !0));
    ...
    hb.prototype = {
        ...
        primary: function () {
            ...
            this.expect("(") ?
                ...
                this.expect("{") ?
                (a = this.object()) :
                this.peek().identifier && this.peek().text in lb ?
                (a = lb[this.consume().text]) :
        ...
        identifier: function () {
            for (
                var a = this.consume().text; this.peek(".") &&
        ...
        additive: function () {
            for (var a = this.multiplicative(), c;
                (c = this.expect("+", "-"));)
                a = this.binaryFn(a, c.text, this.multiplicative());
            return a;
        },
        multiplicative: function () {
            for (var a = this.unary(), c;
                (c = this.expect("*", "/", "%"));)
        ...
        unary: function () {
            ...
            return this.expect("+") ?
                this.primary() :
                (a = this.expect("-")) ?
                this.binaryFn(hb.ZERO, a.text, this.unary()) :
                (a = this.expect("!")) ?
    ...
    var yd = function (a) {
        ...
        Dd = {
            ...
            "datetime-local": jb(
                "datetimelocal",
                Ad,
                Lb(Ad, "yyyy MM dd HH mm ss sss".split(" ")),
            ...
            function (a, c, d, e, f, g, h, l, k, m) {
                ...
                this.$validate = function () {
                    if (!V(p.$modelValue) || !isNaN(p.$modelValue)) {
                        ...
                        p.$$runValidators(
                            p.$error[p.$$parserName || "parse"] ? !1 : t,
                            a,
                ...
                this.$$parseAndValidate = function () {
                    ...
                    g &&
                        ((p.$modelValue = c),
                            p.$modelValue !== f && p.$$writeModelToScope());
                        ...
                        this.$options.updateOn !== t ?
                            ((this.$options.updateOnDefault = !1),
                                (this.$options.updateOn = U(
                                    this.$options.updateOn.replace(dg, function () {
                    ...
                    compile: function (f, g) {
                        ...
                        return function (a, f, g, k, m) {
                            ...
                            a.$watchCollection(n, function (g) {
                                ...
                                for (k = 0; k < H; k++)
                                    if (
                                        ((S = g === G ? k : G[k]), (N = g[S]), (C = I[k]), C.scope)
                                    ) {
                                        E = n;
                                        do E = E.nextSibling;
                            ...
                            function p() {
                                ...
                                for (B = c.length; x < B; x++) {
                                    ...
                                    R.length <= x ?
                                        ...
                                        ((r = R[x]),
                                            (n = r[0]),
                                            n.label != d && n.element.attr("label", (n.label = d)));
                                    J = null;
                                    F = 0;
                                    for (D = l.length; F < D; F++)
                                        ...
                                        ((J = t.element),
                                            ...
                                            (m(N, t.label, !1),
                                                m(N, d.label, !0),
                                                J.text((t.label = d.label)),
                                                J.prop("label", t.label)),
                                            t.id !== d.id && J.val((t.id = d.id)),
                                            J[0].selected !== d.selected &&
                                            (J.prop("selected", (t.selected = d.selected)),
                                                Ra && J.prop("selected", t.selected))) :
                                        ("" === d.id && z ?
                                            (U = z) :
                                            (U = w.clone())
                                            .val(d.id)
                                            ...
                                            m(N, d.label, !0),
                                            J ? J.after(U) : n.element.append(U),
                                            (J = U));
                                    for (F++; r.length > F;)
